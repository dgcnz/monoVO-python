import numpy as np
import cv2
from keypoint_extractors import KeypointExtractor
...
class VisualOdometry:
    def __init__(self, cam, annotations, extractor: KeypointExtractor):
        self.frame_stage = 0
        self.cam = cam
        self.new_frame = None
    ...
    def processSecondFrame(self):
        ...
        self.px_ref, self.px_cur = self.extractor.extract(
